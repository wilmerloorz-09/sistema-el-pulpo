-- Extra: al cobrar total queda PAID y sigue flujo manual de despacho (como mesa).
-- Se deja de invocar auto_finalize_extra_order_after_payment desde sync de pagos.
