-- Auto-apertura de caja con plantilla para el cajero principal (mismo comportamiento que secundarios).
...
BEGIN
  ...
  -- Apertura automatica del cajero principal con su plantilla asignada.
  IF p_primary_cashier_id IS NOT NULL THEN
    IF NOT EXISTS (
      SELECT 1
