-- Fix: COALESCE sobre enum order_type con '' rompia la anulacion (22P02 invalid input value for enum).
-- Se castea a text antes de comparar, en cancel_order_quantities y set_draft_order_item_quantity.
...
-- Despacho primero: permitir cancelar lineas aun no despachadas sin autorizacion,
-- incluso si la orden ya paso a READY (lista para despachar).
