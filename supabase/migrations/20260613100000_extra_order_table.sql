-- Permite asignar un table_id al crear una orden extra.
...
REVOKE ALL ON FUNCTION public.create_extra_order(uuid, uuid, uuid) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION public.create_extra_order(uuid, uuid, uuid) TO authenticated;
