-- =============================================================================
-- Cola Despacho/Servir en 1 RTT (bundle JSON)
-- =============================================================================
-- Sustituye el fan-out del cliente (órdenes + pagos + ítems + modifiers +
-- snapshots + mesas + profiles + packers) por una sola RPC set-based.
-- La elegibilidad por workflow / assignments / platos sigue en el front.
-- =============================================================================
