-- Al salir de la vista de orden: borrar en servidor borradores de mesa sin lineas (0 order_items).
-- No depende del cache del cliente. Quien creo el borrador vacio puede purgarlo aun sin permisos de admin.
...
BEGIN
  ...
  -- Igual que delete_dine_in_table_order: operate/admin O turno habilitado con capacidad; ademas creador del borrador vacio.
  IF NOT (
    v_has_operate_permission
    OR v_shift_gate_ok
    OR v_creator_empty
