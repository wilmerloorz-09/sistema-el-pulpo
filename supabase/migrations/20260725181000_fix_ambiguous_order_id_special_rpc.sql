-- Corrige ambigüedad PL/pgSQL: RETURNS TABLE (order_id ...) crea una variable
-- que choca con order_items.order_id.
...
GRANT EXECUTE ON FUNCTION public.actualizar_valor_grupo_especial(uuid, numeric) TO service_role;
