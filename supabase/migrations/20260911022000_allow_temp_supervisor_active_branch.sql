-- Permite que un supervisor temporal active la sucursal delegada del dia.
-- Antes ensure_active_branch_membership solo miraba user_branches / turno abierto,
-- y get_my_access_context fallaba al priorizar la sucursal delegada
-- ("La sucursal activa debe estar habilitada para el usuario" -> Sin sucursales asignadas).
