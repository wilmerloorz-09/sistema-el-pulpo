-- Reportes y Pago del personal: solo administracion, no supervisores
-- (permanentes ni temporales).
...
WHERE rp.role_id = r.id
  ...
  AND m.code IN ('reportes_sucursal', 'jornadas_personal');

-- Ajuste de inyeccion del supervisor temporal: sin reportes ni pago del personal.
