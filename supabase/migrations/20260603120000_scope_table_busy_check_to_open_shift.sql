-- Turno nuevo = mesas limpias: create_dine_in_order solo bloquea si hay orden activa
-- en la MISMA mesa y en el turno abierto actual (no turnos anteriores con PAID pendientes).
-- Alineado con get_branch_tables_overview, que ya filtra por cash_shift_id del turno OPEN.
