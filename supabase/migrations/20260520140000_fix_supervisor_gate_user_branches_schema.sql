-- Repara 20260520130000 cuando fallaba: user_branches no tiene role_id.
-- Esta migracion asegura funcion helper + RPC open_cash_shift_with_tables incluso si 201300 aborto antes.
