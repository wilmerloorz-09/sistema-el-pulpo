...
REVOKE ALL ON FUNCTION public.add_tray_order_item(uuid, uuid, integer, numeric, char, numeric, text, uuid[]) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION public.add_tray_order_item(uuid, uuid, integer, numeric, char, numeric, text, uuid[]) TO authenticated;
