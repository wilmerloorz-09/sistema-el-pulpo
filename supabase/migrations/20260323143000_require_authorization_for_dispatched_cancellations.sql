...
BEGIN
  ...
  IF NOT public.can_manage_branch_admin(v_actor_id, v_order.branch_id) THEN
    ...
    v_can_direct_by_turn := COALESCE(v_gate.can_authorize_order_cancel, false) OR COALESCE(v_gate.is_supervisor, false);
    ...
    IF v_has_dispatched_targets OR NOT v_can_direct_by_turn OR v_requires_authorization THEN
